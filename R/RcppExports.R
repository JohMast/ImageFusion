...
execute_fitfc_job_cpp <- function(input_filenames, input_resolutions, input_dates, pred_dates, pred_filenames, pred_area, winsize, date1, n_cores, n_neighbors, output_masks, use_nodata_value, verbose, resolution_factor, hightag, lowtag, MASKIMG_options, MASKRANGE_options) {
    invisible(.Call('_ImageFusion_execute_fitfc_job_cpp', PACKAGE = 'ImageFusion', input_filenames, input_resolutions, input_dates, pred_dates, pred_filenames, pred_area, winsize, date1, n_cores, n_neighbors, output_masks, use_nodata_value, verbose, resolution_factor, hightag, lowtag, MASKIMG_options, MASKRANGE_options))
}
...
execute_imginterp_job_cpp <- function(input_filenames, input_dates, input_string, MASKIMG_options, MASKRANGE_options) {
    invisible(.Call('_ImageFusion_execute_imginterp_job_cpp', PACKAGE = 'ImageFusion', input_filenames, input_dates, input_string, MASKIMG_options, MASKRANGE_options))
}
