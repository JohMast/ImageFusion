...
#' @export
execute_estarfm_job_cpp <- function(input_filenames, input_resolutions, input_dates, pred_dates, pred_filenames, pred_area, winsize, date1, date3, use_local_tol, use_quality_weighted_regression, uncertainty_factor, number_classes, data_range_min, data_range_max, hightag, lowtag) {
