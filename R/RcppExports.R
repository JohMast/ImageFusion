...
execute_fitfc_job_cpp <- function(input_filenames, input_resolutions, input_dates, pred_dates, pred_filenames, pred_area, winsize, date1, n_cores, n_neighbors, output_masks, use_nodata_value, use_parallelisation, verbose, resolution_factor, hightag, lowtag, MASKIMG_options, MASKRANGE_options) {
    invisible(.Call(`_ImageFusion_execute_fitfc_job_cpp`, input_filenames, input_resolutions, input_dates, pred_dates, pred_filenames, pred_area, winsize, date1, n_cores, n_neighbors, output_masks, use_nodata_value, use_parallelisation, verbose, resolution_factor, hightag, lowtag, MASKIMG_options, MASKRANGE_options))
}
